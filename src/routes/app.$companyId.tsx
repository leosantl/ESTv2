...
function CompanyLayout() {
  ...
  const gate = (feature: Parameters<typeof planHasFeature>[1]) =>
    isSuperAdmin || planHasFeature(planId, feature);
  ...
  const groups: NavGroup[] = [
    ...
    },
    {
      label: "Enterprise",
      items: [
        { title: "Unidades", url: `${base}/units`, icon: Building2, locked: !gate("loja"), requiredPlan: "enterprise" },
      ],
    },
  ];
  ...
  return (
    ...
    >
      <UnitProvider companyId={companyId}>
        <Outlet />
      </UnitProvider>
    </AppShell>
  );
